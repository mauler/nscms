...
class Question(ContentModel):
    finished = models.BooleanField(verbose_name=u"Finalizada",
                                   help_text=u"Indica que a enquete esta finalizada e mostrara o resultado.",
                                   default=False)
    class Meta:
