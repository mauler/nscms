...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'tinyportal_channel', (
            ...
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['tinyportal.Channel'])),
            (u'lft', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            (u'rght', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            (u'tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            (u'level', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
        ))
        db.send_create_signal(u'tinyportal', ['Channel'])

        # Adding model 'Container'
        db.create_table(u'tinyportal_container', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, db_index=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, db_index=True, blank=True)),
            ('channel', self.gf('mptt.fields.TreeForeignKey')(to=orm['tinyportal.Channel'])),
        ))
        db.send_create_signal(u'tinyportal', ['Container'])


    def backwards(self, orm):
        # Deleting model 'Channel'
        db.delete_table(u'tinyportal_channel')

        # Deleting model 'Container'
        db.delete_table(u'tinyportal_container')
