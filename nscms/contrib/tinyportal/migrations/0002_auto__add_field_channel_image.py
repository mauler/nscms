...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Channel.image'
        db.add_column(u'tinyportal_channel', 'image',
                      self.gf(u'sorl.thumbnail.fields.ImageField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Channel.image'
        db.delete_column(u'tinyportal_channel', 'image')
